...
Each program estimates an LCGA model, where the number of trajectories range from 1 to 10.

For more information, please contact Marc Simard at
marc.simard@inspq.qc.ca